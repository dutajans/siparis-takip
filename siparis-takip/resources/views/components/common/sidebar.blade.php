    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'users'}" @click="activeDropdown === 'users' ? activeDropdown = null : activeDropdown = 'users'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Kullanıcı Yönetimi') }}</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'users'" x-collapse class="sub-menu text-gray-500">
                        @can('yonet-kullanicilar')
                        <li>
                            <a href="{{ route('kullanicilar.index') }}">{{ __('Kullanıcılar') }}</a>
                        </li>
                        @endcan
                        @can('yonet-roller')
                        <li>
                            <a href="{{ route('roller.index') }}">{{ __('Roller') }}</a>
                        </li>
                        @endcan
                    </ul>
                </li>

                <!-- Firma Ayarları Menüsü -->
                @can('firma.ayarlar')
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{'active' : activeDropdown === 'settings'}" @click="activeDropdown === 'settings' ? activeDropdown = null : activeDropdown = 'settings'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Firma Ayarları') }}</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'settings'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="{{ route('firma.ayarlar') }}">{{ __('Genel Ayarlar') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('firma.paketler') }}">{{ __('Paketler') }}</a>
                        </li>
                    </ul>
                </li>
                @endcan
                ...
                @can('entegrasyon.yonet')
                <li class="menu nav-item">
                    <a href="{{ route('pazaryerleri.index') }}" class="nav-link group">
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Entegrasyonlar') }}</span>
                        </div>
                    </a>
                </li>
                @endcan
