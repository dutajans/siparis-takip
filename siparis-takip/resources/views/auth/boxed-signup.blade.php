                        ...
                        <form class="space-y-5 dark:text-white" method="POST" action="{{ route('register') }}">
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="name" name="name" type="text" placeholder="Enter Name" class="form-input ps-10 placeholder:text-white-dark" value="{{ old('name') }}" required />
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="Email" name="email" type="email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark" value="{{ old('email') }}" required />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <!-- Email ikon SVG -->
                                    </span>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Confirm Password" class="form-input ps-10 placeholder:text-white-dark" required />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <!-- Password ikon SVG -->
                                    </span>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="firma_adi" name="firma_adi" type="text" placeholder="Firma Adı" class="form-input ps-10 placeholder:text-white-dark" value="{{ old('firma_adi') }}" required />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <!-- Firma ikon SVG -->
                                    </span>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="firma_kodu" name="firma_kodu" type="text" placeholder="Firma Kodu" class="form-input ps-10 placeholder:text-white-dark" value="{{ old('firma_kodu') }}" required />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <!-- Kod ikon SVG -->
                                    </span>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="domain" name="domain" type="text" placeholder="ornek.com" class="form-input ps-10 placeholder:text-white-dark" value="{{ old('domain') }}" required />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <!-- Domain ikon SVG -->
                                    </span>
                                </div>
